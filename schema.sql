...
do $$
begin
  if not exists (select 1 from public.admins where user_id = 'a41ee4c2-4826-4c75-89be-b21765bf7752'::uuid) then
    insert into public.admins (user_id) values ('a41ee4c2-4826-4c75-89be-b21765bf7752'::uuid);
  end if;
end$$;
...
-- ============ IMG NORMALIZATION (IMPROVED: supports images & menu-images) ============
...
declare
  ...
  _host     constant text := 'https://ivotznbljtzjdmlsyqcq.supabase.co';
  _bucket   text;
  _path     text;
begin
...
-- Backfill قديم (سيحوّل أي قيمة img إلى رابط عام صحيح لأي من البكتين)
